 ! function (e) {
     ...
     function a(e, t, i, a) {
         return e && e.exif && e.exif.gps && Array.isArray(e.exif.gps) ? g(E.get_svg("marker") + U("google maps", i),
             "a", t, U("google maps", a), (n = e.exif.gps, Array.isArray(n) ?
                 "https://www.google.com/maps/search/?api=1&query=" + n : "#")) : "";
         var n
     }
     function n(e, t) {
         var i = !!e.url_path && encodeURI(e.url_path);
         return "dir" === e.filetype ? i || "#" : !i || t && ["php", "htaccess"].includes(e.ext) || _c.load_files_proxy_php ?
             _c.script + (t ? "?download=" : "?file=") + encodeURIComponent(e.path) : i
     }
     function o(e) {
     ...
     function d(e, t, i) {
         return _c.context_menu && e ? '<button class="context-button' + (t ? " " + t : "") + '" data-action="context"' +
             f(!!i && G("选项")) + ">" + E.get_svg_multi("dots", "minus") + "</button>" : ""
     }
     function m(e, t, i, a) {
         if (!e || !e.iptc) return "";
         var n = M(a || ["title", "description", "keywords"], (function (i, a) {
             var n = e.iptc[i];
             if (n) return "keywords" === i && Array.isArray(n) && (n = n.join(", ")), g(n, "div", t ? t +
                 "-" + i : i)
         }));
     ...
     function v(e, t, i, n) {
         return e && e.exif ? g(M(u, (function (t) {
             var i = e.exif[t];
             if (!i) return "";
             if ("Model" === t) i = E.get_svg(i.toLowerCase().indexOf("phone") > -1 ? "cellphone" :
                 "camera") + i;
             else if ("FocalLength" === t) {
                 var o = i.split("/");
                 2 === o.length && (i = (o[0] / o[1]).toFixed(1) + "<small>mm</small>")
             } else "ISOSpeedRatings" === t ? i = "<small>ISO</small>" + i : "gps" === t && (i = a(e,
                 "google-maps-link", !1, !0));
             return n && "gps" !== t && (i = g(i, "span", null, G(t))), g(i, "span", "exif-item exif-" +
                 t)
         })), t, i) : ""
     }
     function f(e) {
     ...
     function g(e, t, i, a, n, o) {
         return e ? t ? "<" + t + (p = "class", (l = i) ? " " + p + '="' + l + '"' : "") + f(a) + (n ? ' href="' + n +
             '" target="_blank"' + (o ? " download" : "") : "") + ">" + e + "</" + t + ">" : e : "";
         var l, p
     }
     function x(e) {
     ...
     function S(e, t, i) {
         return !!W.local_storage && (void 0 === t ? localStorage.getItem(e) : !0 === t ? localStorage.removeItem(e) :
     ...
     function q(e) {
         ...
         return t.open(i ? "POST" : "GET", e.url || _c.script), i && t.setRequestHeader("Content-Type",
                 "application/x-www-form-urlencoded"), e.url || t.setRequestHeader("X-Requested-With", "XMLHttpRequest"),
             e.json_response && t.setRequestHeader("Accept", "application/json"), t.send(i || null), t
     }
     function I(e) {
     ...
     function Z(e, t, i, a) {
         var n = '<div class="modal fade" id="' + e + '" tabindex="-1" aria-labelledby="' + e +
             '-label" aria-hidden="true">\t\t  <div class="modal-dialog">\t\t    <div class="modal-content">\t\t      <div class="modal-body">' +
             i + "</div>\t\t      " + (a ? '<div class="modal-footer">' + a + "</div>" : "") +
             "\t\t    </div>\t\t  </div>\t\t</div>";
     ...
     function F(e, t) {
         if (t) {
             ...
             if (!(i.length < 2 || i[0] !== e)) return W.hasOwnProperty(e) || (W[e] = function () {
                 ...
                 var t = "audio" === e ? ["mpeg", "mp4", "x-aiff", "ogg", "x-m4a", "aac", "webm", "wave",
                     "wav", "x-wav", "x-pn-wav", "flac"] : ["mp4", "webm", "ogg", "3gp", "m4v", "x-m4v"];
                 try {
         ...
         !e.explorer && n && CSS.supports("color", "var(--fake-var)") || (document.body.innerHTML =
             ...
             }(), e.is_touch = "ontouchstart" in a || i.maxTouchPoints > 0 || i.msMaxTouchPoints > 0 || window.DocumentTouch &&
             document instanceof DocumentTouch || a.matchMedia("(any-pointer: coarse)").matches, e.is_pointer = !e.is_touch ||
             matchMedia("(pointer:fine)").matches, e.pointer_events = !!("PointerEvent" in window), e.is_mac = i.platform
             .toUpperCase().indexOf("MAC") >= 0, e.scrollbar_width = e.is_pointer ? function () {
             ...
             }() : 0, e.pixel_ratio = a.devicePixelRatio || 1, e.download = "download" in t.createElement("a"), e.clipboard = !
             (!t.queryCommandSupported || !t.queryCommandSupported("copy")), e.url = !("function" != typeof URL), e.fullscreen =
             screenfull.isEnabled, e.image_orientation = CSS.supports("image-orientation", "from-image"), e.browser_images = [
         ...
         o.onload = o.onerror = function () {
             ...
             e.history = !(!a.history || !history.pushState), e.history || (_c.history = !1)
     }(), j("tests", W),
         function () {
             if (W.local_storage) {
                 var e = z("clearall", !0),
         ...
         function () {
             ...
             a && V(Object.keys(a), (function (e) {
                 ...
                 if (_c[e] !== a && (_c[e] = a, W.local_storage)) {
                     ...
                     V(t, (function (e) {
                         _c[e] !== i[e] && (n[e] = _c[e])
                     })), S("files:options:" + _c.location_hash, !Object.keys(n).length || JSON.stringify(n),
                         100)
                 }
             }, N.ls_options = e("files:ls_options") || {}, E.ls_option = function (e, t) {
                 N.ls_options[e] = t, S("files:ls_options", !Object.keys(N.ls_options).length || JSON.stringify(N.ls_options),
                     100)
             }
         }();
     var P, B, D = {};
     ...
     function X(e, t) {
         return "" === e && (e = "ROOT"), "files:dir:" + _c.dirs_hash + ":" + (e || _c.current_dir.path) + ":" + (t ||
             _c.current_dir.mtime)
     }! function () {
         ...
         N.plugins = {
             ...
             cGF5cGFs: {
                 src: [O("aHR0cHM6Ly93d3cucGF5cGFsLmNvbS9zZGsvanM/Y2xpZW50LWlkPQ==") + (location.search.includes(
                     "sandbox") ? O(
                     "QWRETjBCNzJWSUlHQk5HZnpOTHpfT0YtVGJ6MkxYcnhQeFNTamduUllmVUJFRnJZckp3eWV4cGsyM1VsZHh4ZnNmN3FSU2dvZG9OS3g1bTY="
                 ) : O(
                     "QVJFNEg3UWNvWG1LS1dUZktrLXBYQW5zSWZXMVpveDNidXdLbWFfeS1tbjRSalFaalM4R2hwMS1KVXhjZXZua2w1S0kwdkwtVUlKLXVFZlU="
                 ))],
                 type: "js"
             }
         ...
         })), "scroll" === _c.topbar_sticky && getComputedStyle(R.topbar).position.match("sticky") && E.load_plugin(
             "headroom", (function () {
     ...
     function () {
         ...
         var i = {
                 ...
                 cd: ["dmg", "iso", "bin", "cd", "cdr", "cue", "disc", "disk", "dsk", "dvd", "dvdr", "hdd", "hdi",
                     "hds", "hfs", "hfv", "ima", "image", "imd", "img", "mdf", "mdx", "nrg", "omg", "toast", "cso",
                     "mds"],
         ...
         V(Object.keys(i), (function (e) {
             ...
             return o || "image" !== n || (o = i.mime.split("/")[1] || !1),
                 '<svg viewBox="0 0 56 56" class="img-svg svg-file-icon' + (n ? " svg-icon-" + n : "") + (a ? " " +
                     a : "") +
                 '"><path class="svg-file-icon-bg" d="M36.985,0H7.963C7.155,0,6.5,0.655,6.5,1.926V55c0,0.345,0.655,1,1.463,1h40.074 c0.808,0,1.463-0.655,1.463-1V12.978c0-0.696-0.093-0.92-0.257-1.085L37.607,0.257C37.442,0.093,37.218,0,36.985,0z"/><polygon  class="svg-file-icon-flip" points="37.5,0.151 37.5,12 49.349,12"/>' +
                 (n ? '<g class="svg-file-icon-icon">' + e[n] + "</g>" : "") + (o ?
         ...
         E.get_svg = function (e) {
             ...
             return '<svg viewBox="0 0 24 24" class="svg-icon svg-icon-' + arguments[0] + '">' + M(arguments, (
                 function (e) {
     ...
     function () {
         ...
         if (E.breadcrumbs_info = function () {
                 e(_c.files_count + " " + (_c.current_dir.images_count === _c.files_count ? G("images", "image", _c.files_count) :
                     _c.current_dir.files_count === _c.files_count ? G("文件", "文件", _c.files_count) : !_c.current_dir
                     .files_count && _c.files_count ? G("文件夹", "文件夹", _c.files_count) : G("项目", "项目", _c.files_count)
         ...
         function l(e, i) {
             return '<li class="crumb"><a href="' + o(e) + '" data-path="' + t(e) + '" class="crumb-link"' + (e ? "" :
                 ' title="' + G("首页") + '"') + ">" + i + "</a></li>"
         }
         function s(e, t) {
             var i = {
         ...
         function c() {
             ...
             a.length && V(a, (function (a, p) {
                 ...
                 })))), n = a.slice(0), R.breadcrumbs.lastChild != R.breadcrumbs.firstChild && R.breadcrumbs.lastChild.classList
                 .add("crumb-active")
         }
     }(), _c.prevent_right_click && (b(document, (function (e) {
             ("IMG" === e.target.nodeName || "VIDEO" === e.target.nodeName || e.target.closest(".menu-li") ||
                 e.target.closest(".files-li")) && e.preventDefault()
         }), "contextmenu"), document.documentElement.style.setProperty("--touch-callout", "none")),
         function () {
             function e(e, t, i, a) {
                 return a ? '<button class="dropdown-item" data-action="' + i + '">' + E.get_svg(t) + G(e) +
                     "</button>" : ""
             }
             function l() {
             ...
             function p(e, t) {
                 if (e != N.contextmenu.is_open) {
                     ...
                     document.documentElement[i]("click", l), document[i]("contextmenu", l), document[i](
                         "visibilitychange", l), window[i]("blur", l), window[i]("scroll", l), R.sidebar_menu && R.sidebar_menu[
                         i]("scroll", l), N.contextmenu.is_open = e
                 }
                 N.contextmenu.el.classList.toggle("cm-active", e), N.contextmenu.li && N.contextmenu.li.classList.toggle(
                     "cm-active", e), anime.remove(R.contextmenu), anime({
                 ...
                 if (_c.context_menu) {
                     ...
                     if (d) {
                         ...
                         if (N.contextmenu.is_open) {
                             ...
                             N.contextmenu.el.classList.remove("cm-active"), N.contextmenu.li && N.contextmenu.li.classList
                                 .remove("cm-active")
                         }
                         ...
                         if (N.contextmenu.item = l || _c["sidebar" === c ? "dirs" : "files"][v], N.contextmenu.item) {
                             o.stopPropagation(), (m || u) && (R.contextmenu.innerHTML =
                                 '<h6 class="dropdown-header" title="' + t(N.contextmenu.item.basename) + '">' +
                                 E.get_svg_file_icon(N.contextmenu.item) + i(N.contextmenu.item.basename) +
                                 "</h6>" + e("放大", "zoom_in", "popup", "popup" !== c && N.contextmenu.item.is_browser_image &&
                                     N.contextmenu.item.is_readable) + e("打开", "folder_open", "folder",
                                     "sidebar" !== c && "dir" === N.contextmenu.item.filetype) + e("显示信息",
                                     "info", "modal", !["modal", "popup"].includes(c)) + function (e, t, i, a) {
                                     if (!e) return "";
                                     var o = n(e);
                                     return o && "#" !== o ? g(E.get_svg("open_in_new") + U("在新标签页中打开", i), "a",
                                         t, U("在新标签页中打开", a), o) : ""
                                 }(N.contextmenu.item, "dropdown-item", !0) + e("复制链接", "clipboard",
                                     "clipboard", W.url && W.clipboard && N.contextmenu.item.url_path) +
                                 function (e, t, i, a) {
                                     return W.download && "dir" !== e.filetype && e.is_readable ? g(E.get_svg(
                                         "download") + U("下载", i), "a", t, U("下载", a), n(e, !0), !0) : ""
                                 }(N.contextmenu.item, "dropdown-item", !0) + a(N.contextmenu.item.image,
                                     "dropdown-item", !0)), R.contextmenu.style.display = "block";
                             ...
                             var w = (d.clientWidth > 500 || "sidebar" === c ? o.clientX : f.left + d.offsetWidth /
                                     2) - R.contextmenu.clientWidth / 2,
                                 y = Math.max(10, Math.min(document.documentElement.clientWidth - R.contextmenu.clientWidth -
                                     10, w));
                             R.contextmenu.style.left = Math.round(y) + "px", R.contextmenu.style.setProperty(
                                     "--offset", Math.round(Math.max(10, Math.min(R.contextmenu.clientWidth - 10, R
                                         .contextmenu.clientWidth / 2 - y + w))) + "px"), R.contextmenu.classList.toggle(
                                     "cm-top", _), R.contextmenu.classList.toggle("cm-bottom", b), R.contextmenu.classList
                                 .toggle("cm-border", "sidebar" === c), p(!0, b), o.preventDefault()
                         }
                     }
                 }
             }, _c.prevent_right_click || R.list_ul.addEventListener("contextmenu", E.create_contextmenu), s(R.contextmenu,
                 (function (e, t) {
                     "popup" === e ? (_c.history && N.modal.open && N.modal.popstate.remove(), E.open_popup(N.contextmenu
                             .item.path)) : "folder" === e ? E.get_files(N.contextmenu.item.path, "push") :
                         "modal" === e ? E.open_modal(N.contextmenu.item, !0) : "clipboard" === e && o(n(N.contextmenu
                             .item))
                 }))
         }(),
         function () {
             ...
             E.get_time = function (t, i, a, n) {
                 ...
                 return '<time datetime="' + o.format() + '" data-time="' + t.mtime + '" data-format="' + i + '"' +
                     (a && W.is_pointer ? ' data-tooltip="' + o.format(a) + '" data-tooltip-format="' + a + '"' :
                         "") + ">" + e(o, i, n) + "</time>"
             ...
             if (t && t.length) {
                 var i = ["af", "ar", "ar-dz", "ar-kw", "ar-ly", "ar-ma", "ar-sa", "ar-tn", "az", "be", "bg", "bm",
                     "bn", "bo", "br", "bs", "ca", "cs", "cv", "cy", "da", "de", "de-at", "de-ch", "dv", "el", "en",
                     "en-au", "en-ca", "en-gb", "en-ie", "en-il", "en-nz", "en-SG", "eo", "es", "es-do", "es-us",
                     "et", "eu", "fa", "fi", "fo", "fr", "fr-ca", "fr-ch", "fy", "ga", "gd", "gl", "gom-latn", "gu",
                     "he", "hi", "hr", "hu", "hy-am", "id", "is", "it", "it-ch", "ja", "jv", "ka", "kk", "km", "kn",
                     "ko", "ku", "ky", "lb", "lo", "lt", "lv", "me", "mi", "mk", "ml", "mn", "mr", "ms", "ms-my",
                     "mt", "my", "nb", "ne", "nl", "nl-be", "nn", "oc-lnc", "pa-in", "pl", "pt", "pt-br", "ro",
                     "ru", "sd", "se", "si", "sk", "sl", "sq", "sr", "sr-cyrl", "ss", "sv", "sw", "ta", "te", "tet",
                     "tg", "th", "tl-ph", "tlh", "tr", "tzl", "tzm", "tzm-latn", "ug-cn", "uk", "ur", "uz",
                     "uz-latn", "vi", "x-pseudo", "yo", "zh-cn", "zh-hk", "zh-tw"];
                 t.some((function (e) {
                 ...
                 if (t) return E.load_plugin("dayjs_locale", (function () {
                     dayjs.locale(t), V(_tag("time"), (function (t) {
                         if (t.dataset.time) {
                             ...
                             t.innerHTML = e(i, t.dataset.format, t.children[0]), t.dataset
                                 .tooltipFormat && (t.dataset.tooltip = i.format(t.dataset.tooltipFormat))
                         }
             ...
             function n(e) {
                 return !!["en", "en-us"].includes(e) || ("zn" === e ? a("zh-cn") : "no" === e ? a("nb") : i.includes(e) ?
                     a(e) : void 0)
             }
         }(), N.dropdown = {}, P = W.pointer_events ? "pointerup" : "click", B = W.pointer_events ? "pointerdown" :
         "mousedown", E.dropdown = function (e, t, i) {
             var a;
             b(t, (function (t) {
                 "mouse" === t.pointerType ? i && i() : (e.classList.contains("touch-open") ? a.remove() :
                     a = H(document, B, (function (t) {
                         t.target.closest(".dropdown") !== e && (a.remove(), e.classList.remove(
                             "touch-open"))
         ...
         function () {
             var e = !1,
                 o = W.pixel_ratio >= 1.5 && _c.image_resize_dimensions_retina ? _c.image_resize_dimensions_retina : _c
                 ...
                 return _c.current_dir.html = M(_c.file_names, (function (e, l) {
                     ...
                     if (h || s.mime || !s.ext || (s.mime = Q[s.ext]), !h && s.mime) {
                         ...
                         if ("image" === _[0]) {
                             s.is_image = !0;
                             var b = _[1];
                             W.browser_images.includes(b) && (s.is_browser_image = b, _c.resize_image_types
                                 .includes(b) ? s.is_resize_image = !0 : "svg+xml" === b ? s.is_browser_image =
                                 "svg" : "vnd.microsoft.icon" !== b && "x-icon" !== b || (s.is_browser_image =
                                     "ico"))
                         }
                     }
                     if (_c.load_images && s.is_readable && s.is_browser_image && ("svg" === s.is_browser_image ?
                             s.filesize < _c.load_svg_max_filesize && (f = "svg") : "ico" === s.is_browser_image ?
                             f = "svg" : (s.is_resize_image && function (e) {
                                     if (_c.image_resize_enabled && e && e.width && e.height) {
                                         ...
                                         if (!(t < p || _c.image_resize_max_pixels && i > _c.image_resize_max_pixels)) {
                                             if (_c.image_resize_memory_limit) {
                                                 var a = e.width / t,
                                                     n = e.height / t;
                                                 if ((i * (e.bits ? e.bits / 8 : 1) * (e.channels || 3) *
                                                         1.33 + a * n * 4) / 1048576 > _c.image_resize_memory_limit)
                                                     return
                                             }
                                             return !0
                                         }
                                     }
                                 }(s.image) && (x = o), (x || s.filesize <= _c.load_images_max_filesize) &&
                                 (f = "img", s.image && (u = s.image.width / s.image.height)))), f) var w =
                         '<img class="img img-' + f + ' lazy" data-src="' + function () {
                             if (x && s.image["resize" + x]) return encodeURI(s.image["resize" + x]);
                             if (x || _c.load_files_proxy_php || !s.url_path) {
                                 var e = s.mtime + "." + s.filesize;
                                 return _c.script + "?file=" + encodeURIComponent(s.path) + (x ?
                                     "&resize=" + x + "&" + _c.image_cache_hash + "." + e : "&" + e
                                 )
                             }
                             return t(s.url_path)
                         }() + '">';
                     ...
                     return function (e) {
                             ...
                             if (i) {
                                 ...
                                 a && n && (t += a === n ? ",square" : a > n ? ",landscape,horizontal" :
                                     "portrait,vertical"), o && (t += ",exif", o.gps && (t +=
                                     ",gps,maps"), t += M(["Make", "Model", "Software"], (function (
                                     e) {
                                     if (o[e]) return "," + o[e]
                                 }))), l && (t += ",iptc", (l.title || l.description) && (t +=
                                     ",caption", l.title && (t += ",title"), l.description && (t +=
                                         ",description")), l.keywords && (t += ",keywords"))
                             }
                             e.features = t
                         }(s), s.sort_name = s.basename.toLowerCase(), s.DateTimeOriginal && (s.mtime = s.DateTimeOriginal),
                         '<li class="' + H + '" style="--ratio:' + u + '" data-name="' + t(s.basename) +
                         '">' + g(w, "a", y, !1, n(s, "download" === _c.click), !h && "download" === _c.click) +
                         '<div class="data">' + a(s.image, "gps", !1, !0) + g(i(s.basename), "span", "name") +
                         m(s.image, !1, !1, ["title"]) + g(E.get_svg_file_icon(s), "span", "icon") + g(!h &&
                             s.mime, "span", "mime") + c(s.image, "span", "dimensions") + r(s, "span",
                             "size") + v(s.image, "span", "exif", !0) + (h ? "" : '<span class="ext">' + g(
                             s.ext, "span", "ext-inner") + "</span>") + g(E.get_time(s, "ll", "llll", !1),
                             "span", "date") + '<span class="flex"></span></div>' + d("menu" !== _c.click ||
                             h, "files-context") + "</li>"
                 })), _c.current_dir.html
             }
             function y(e, t, i) {
                 ...
                 document.title = a, t && _c.history && history[t + "State"]({
                         path: e
                     }, a, f(t, e)), _c.files = _c.current_dir.files, j(i + " :", e, _c.current_dir), _c.file_names =
                     Object.keys(_c.files), _c.files_count = _c.file_names.length, _c.breadcrumbs && E.breadcrumbs_info(),
                     A(R.list_ul, _c.files_count, !0), _c.files_count || E.topbar_info(E.get_svg("alert_circle_outline") +
                         G("目录为空"), "warning"), _c.files_count && (R.filter.disabled = !1), _c.files_count && (R.list_ul
                         .innerHTML = _c.current_dir.html || w(), N.list = new List(R.list, {}), V(_c.file_names, (
                             function (e, t) {
             ...
             function H(e, t) {
                 return _c.dirs[e] ? t ? _c.dirs[e].mtime > t.mtime ? _c.dirs[e] = Object.assign(t, _c.dirs[e]) :
                     Object.assign(_c.dirs[e], t) : _c.dirs[e] : _c.dirs[e] = t || {}
             }
             function k(e, t, i) {
                 E.topbar_info(E.get_svg("alert_circle_outline") + "<strong>" + G("Error") + "</strong>" + (e ? ": " +
                     e : "."), "error"), i && _c.history && history[i + "State"]({
                     path: t
                 }, G("Error") + (e ? ": " + e : "."), f(i, t))
             }
             b(R.filter, (function () {
                 ...
                 if (t !== _c.current_path) {
                     _c.current_path = t, E.topbar_info(), R.filter.value = null, R.filter.disabled = !0, R.filter.classList
                         .remove("nomatches"), _c.breadcrumbs && E.set_breadcrumbs(t), _c.menu_enabled && E.set_menu_active(
                             t);
                     var a = _c.dirs[t];
                     if (a) {
                     ...
                     u(!1, (function () {
                         ...
                         complete: function (a, n, o) {
                             if (e = !1, _c.menu_enabled && E.menu_loading(!1, !1), !o || !a || a.error)
                                 return k((a.error || "") + " " + t, t, i), R.topbar.classList.remove(
                                     "topbar-spinner"), void j("files error", a.error || "Error");
                 ...
                 if (_c.query_path) return _c.query_path_valid ? E.get_files(_c.query_path, "replace") : k(
                     "Invalid directory path <strong>" + _c.query_path + "</strong>", _c.query_path,
                     "replace");
                 if (location.search) {
                     ...
                     if (e && "debug" !== e && (-1 === e.indexOf("=") || e.indexOf("/") > -1)) {
                         ...
                         return void(t || !_c.menu_enabled ? (t && H(_c.query_path, t), E.get_files(_c.query_path,
             ...
             E.menu_init_files = function (e) {
                 ...
                 if ("UL" !== e.target.nodeName && ("A" !== e.target.nodeName || e.target.classList.contains(
                         "img-wrapper"))) {
                     var t = e.target.closest("li"),
                         i = _c.files[t.dataset.name];
                     if (i) {
                         if (e.target.classList.contains("context-button")) return E.create_contextmenu(e,
                             i, e.target, "files");
                         var a = "dir" === i.filetype;
                         if (N.contextmenu.is_open && ("menu" !== _c.click || a)) return e.preventDefault();
                         _(e, t.firstChild, !a && ["download", "window"].includes(_c.click)) || (a ? (H(i.path,
                                 i), E.get_files(i.path, "push")) : "menu" === _c.click ? E.create_contextmenu(
                                 e, i, t, "files") : "popup" === _c.click && i.is_browser_image && i.is_readable ?
                             E.open_popup(i.path) : E.open_modal(i, !0))
                     }
                 }
             }))
         }(),
         function () {
             ...
             function t() {
                 ...
                 R.list_ul.className = "list " + N.layout.classes + (!_c.image_cover && e ? " img-contain" : ""), l.style
             ...
             }, N.layout.keys = Object.keys(N.layout.layouts), e(N.layout.keys.includes(_c.layout) ? _c.layout :
                 "grid", N.ls_options.layout_subindex || 0);
             var i = _id("change-layout");
             i.innerHTML = '<button type="button" class="btn-icon btn-topbar">' + E.get_svg("layout_" + N.layout.layout) +
                 '</button><div class="dropdown-menu dropdown-menu-right"><h6 class="dropdown-header">' + G("布局") +
                 "</h6>" + M(N.layout.keys, (function (e) {
                     return '<button class="dropdown-item' + (e === N.layout.layout ? " active" + (N.layout.subindex ?
                             " subindex" + N.layout.subindex : "") : "") + '" data-action="' + e + '">' + (N.layout
                             .layouts[e].length > 1 ? E.get_svg_multi("layout_large", "layout_small") : "") + E
                         .get_svg("layout_" + e) + G(e) + "</button>"
                 })) +
                 '<div class="form-check form-switch cover-toggle">\t  <input class="form-check-input" type="checkbox" id="covertoggle"' +
                 (_c.image_cover ? " checked" : "") + '>\t  <label class="form-check-label" for="covertoggle">' + G(
                     "覆盖") + "</label>\t</div></div>";
             var a = i.firstChild,
                 n = i.lastChild,
                 ...
                 p = l.children[0];
             function c(i) {
                 N.layout.layout !== i ? (o[N.layout.index].className = "dropdown-item", e(i, 0), t(), a.innerHTML = E.get_svg(
                         "layout_" + N.layout.layout), o[N.layout.index].className = "dropdown-item active", R.sortbar
                     .className = "sortbar-" + N.layout.layout, E.set_option("layout", N.layout.layout), E.ls_option(
                         "layout_subindex", 0)) : N.layout.current.length < 2 || (N.layout.subindex = N.layout.classes ===
                     N.layout.current[0] ? 1 : 0, N.layout.classes = N.layout.current[N.layout.subindex], o[N.layout
                         .index].className = "dropdown-item active subindex" + N.layout.subindex, t(), R.sortbar.className =
                     "sortbar-" + N.layout.layout + ("list" === N.layout.layout && N.layout.subindex ? "-big" : ""),
     ...
     function J() {
         ...
         var e, t, i = O("ZmlsZXM6cXJ4"),
             ...
             n = location.hostname,
             o = S(i);
         if (!o || o != _c.qrx && O(o) != n) return _c.qrx || !n || n.includes(".") ? !_c.qrx || "string" == typeof _c.qrx &&
             /^[a-f0-9]{32}$/.test(_c.qrx) ? (e = _c.qrx ? "key=" + _c.qrx + "&" : "", t = function (e) {
     ...
     ! function () {
         ...
         R.modal.innerHTML =
             ...
             (e ? '<button type="button" class="btn btn-1 is-icon" data-action="save" data-tooltip="' + G("save") +
                 '">' + E.get_svg("save_edit") + "</button>" : "") +
             '<button type="button" class="btn btn-1 is-icon" data-action="copy" data-tooltip="' + G("复制代码") + '">' + E
             .get_svg("clipboard") +
             '</button><button type="button" class="btn btn-1 is-icon" data-action="fullscreen" data-tooltip="' + G(
                 "全屏窗口") + '">' + E.get_svg_multi("expand", "collapse") +
             '</button></div><button class="btn btn-1 is-icon" data-action="close" data-tooltip="' + G("关闭") + '">' + E
             .get_svg("close") +
         ...
         function C(e) {
             if (N.modal.open = !1, t.file && t.file.abort(), T("esc", "keyup"), N.modal.resize_listener && N.modal.resize_listener
                 .remove(), j(R.modal_bg, [.8, 0]), j(u, [1, 0], [1, .98], (function () {
                     R.modal.scrollTop = 0, document.body.style.paddingRight = "", z(), l(V), l(b), R.modal.classList
                         .remove("modal-code-fullscreen"), u.classList.remove("modal-content-" + N.modal.type),
                         N.modal.code_mirror = !1, "code" === N.modal.type && (k.style.display = "none")
         ...
         function z(e) {
             R.modal.style.display = e ? "block" : "none", R.modal_bg.style.display = e ? "block" : "none", document.body
         ...
         function A(e, t, i, a, n) {
             t && e.classList.toggle(t), i && e.classList.toggle(i), !0 !== n && !1 !== n || (e.disabled = n), a && (e.dataset
                 .tooltip_original || (e.dataset.tooltip_original = e.dataset.tooltip), e.dataset.tooltip = a == e.dataset
                 .tooltip ? e.dataset.tooltip_original : a)
         }
         ...
         E.open_modal = function (o, l) {
             ...
             if (Object.assign(N.modal, {
                 ...
                 if (o.is_browser_image) {
                     N.modal.type = "image", o.image && o.image.width > 800 && o.image.width > o.image.height &&
                         document.documentElement.clientWidth >= 1600 && (f = !0);
                     var x = !(!(o.image && o.image.width && o.image.height && "ico" != o.is_browser_image) || !_c.server_exif &&
                         W.image_orientation || !W.image_orientation && I(o.image)) && o.image.height / Math.max(
                         o.image.width, 500) * 100;
                     s = (x ? '<div style="padding-bottom:' + x + '%">' : "") + '<img data-action="zoom" src="' + n(
                         o) + '" class="modal-image modal-image-' + o.is_browser_image + (x ?
                         " modal-image-intrinsic" : "") + '"></img>' + (x ? "</div>" : "")
                 } else F("video", o.mime) ? (N.modal.type = "video", s = '<video src="' + n(o) + '" type="' + o.mime +
                     '" class="modal-video" controls playsinline disablepictureinpicture controlslist="nodownload"></video>'
                 ) : F("audio", o.mime) ? (N.modal.type = "audio", s = E.get_file_icon(o, "modal-file-icon") +
                     '<audio src="' + n(o) + '" type="' + o.mime +
                     '" class="modal-audio" controls playsinline controlslist="nodownload"></audio>') : (N.modal
                     .code = function (e) {
                         if (e && !(e.filesize > _c.code_max_load)) {
                             ...
                             return t && "null" !== t.mode || !e.ext || (t = CodeMirror.findModeByExtension(e.ext) ||
                                 t), t
                         }
                     }(o), N.modal.code && (N.modal.type = "code", o.filesize > 1e3 && (f = !0), E.load_plugin(
                         "codemirror"), s = '<div class="spinner-border modal-preview-spinner"></div>' + E.get_file_icon(
                         o, "modal-file-icon")));
             s || (s = E.get_file_icon(o, "modal-file-icon"));
             var h, _, w, y, L, A, S = ["image", "file"].includes(N.modal.type) || "dir" === N.modal.type && o.url_path ?
                 "a" : "div",
                 O = "<" + ("a" === S ? 'a href="' + n(o) + '" target="_blank" title="' + G("image" === N.modal.type ?
                     "zoom" : "open in new tab") + '"' : "div") + ' class="modal-preview modal-preview-' + N.modal.type +
                 '">' + s + "</" + S + '><div class="modal-info">' + d(!0, "modal-info-context") + g(i(o.basename),
                     "div", "modal-info-name") + '<div class="modal-info-meta">' + (o.mime ? g(E.get_svg_file_icon(
                     o) + o.mime, "div", "modal-info-mime") : "") + c(o.image, "div", "modal-info-dimensions") + r(
                     o, "div", "modal-info-filesize") + (_ = "div", w = "modal-info-permissions", y = (h = o).is_readable &&
                     h.is_writeable, L = G("文件权限") + ": " + h.fileperms, A = g(E.get_svg(y ? "lock_open_outline" :
                         "lock_outline") + h.fileperms, "span", y ? "is-readwrite" : "not-readwrite", L), g(A, _, w) +
                     "</div>") + g(E.get_svg("date") + E.get_time(o, "llll", !1, !0), "div", "modal-info-date") + v(
                     o.image, "div", "modal-info-exif", !0) + m(o.image, "modal-info", !0) + "</div>";
             a.classList.toggle("modal-lg", f), u.classList.add("modal-content-" + N.modal.type), b.innerText = o.basename,
                 V.innerHTML = O, _c.history && (l && history.pushState(null, o.basename, "#" + encodeURIComponent(
                     o.basename)), N.modal.popstate = H(window, "popstate", C)),
                 function (e) {
                     N.modal.open = Math.random(), T("esc", C, "keyup");
                     var t = document.body.clientWidth;
                     z(!0), document.body.clientWidth > t && (document.body.style.paddingRight = document.body.clientWidth -
                         t + "px");
                             ...
                             complete: function (a) {
                                 t.file = !1, E.load_plugin("codemirror", (function () {
                                     if (N.modal.open === i) {
                                         ...
                                         t && (p(_class("modal-file-icon", V)), N.modal
                                             .code_mirror = CodeMirror(t, {
                                                 value: a,
                                                 lineWrapping: !0,
                                                 lineNumbers: !0,
                                                 readOnly: !e,
                                             ...
                                             }), CodeMirror.autoLoadMode(N.modal
                                                 .code_mirror, N.modal.code.mode
                                             ), N.modal.resize_listener = H(
                                                 window, "resize", M), k.style.display =
                                             "")
                                     }
                                 }))
                             }
         ...
         var Z = w((function (e) {
             var t = N.modal.code_mirror.getValue(),
                 i = t && x(t);
             O(e.target, "btn-1", i ? "btn-success" : "btn-danger", G(i ? "code copied" :
                 "failed to copy code"), !0, 2e3)
         }), 2e3);
         function P(e) {
             if (!L.disabled) {
                 ...
                 e && L.classList.add("show-tooltip"), A(L, null, null, G("saving..."), !0), q({
                     ...
                     json_response: !0,
                     complete: function (e) {
                         O(L, "btn-1", e.success ? "btn-success" : "btn-danger", G(e.success ? "saved" :
                             "failed to save"), !0, 2e3), e.success && S(X(), !0)
                     }
                 })
             }
         }
         ...
         s(R.modal, (function (e, t) {
             ...
             } else "clipboard" === e ? h(t.target, o(N.modal.file.path) ? "btn-success" : "btn-danger", !0) :
                 "copy" === e ? Z(t) : "fullscreen" === e ? B() : "save" === e && P()
         }))
     }();
     var K = function (e, t) {
         var i, a, n, o, l, p, s, c, r, d, m, u, v, f = this,
             ...
             _ = function (e) {
                 ...
                 for (var i, a, n = (e.target || e.srcElement).getAttribute("class") || "", l = 0; l < C.length; l++)
                     (i = C[l]).onTap && n.indexOf("pswp__" + i.name) > -1 && (i.onTap(), a = !0);
                 if (a) {
         ...
         f.init = function () {
             var n;
             t.extend(e.options, h, !0), d = e.options, i = t.getChildByClass(e.scrollWrap, "pswp__ui"), (l = e
                     .listen)("onVerticalDrag", (function (e) {
                     ...
                     e.getZoomLevel() !== i ? e.zoomTo(i, t, 333) : e.zoomTo(d.getDoubleTapZoom(!1, e.currItem),
                         t, 333)
                 })), l("preventDragEvent", (function (e, t, i) {
                     var a = e.target || e.srcElement;
                     a && a.getAttribute("class") && e.type.indexOf("mouse") > -1 && (a.getAttribute(
                             "class").indexOf("__caption") > 0 || /(SMALL|STRONG|EM)/i.test(a.tagName)) &&
                         (i.prevent = !1)
                 })), l("bindEvents", (function () {
                     t.bind(i, "pswpTap click", _), t.bind(e.scrollWrap, "pswpTap", f.onGlobalTap), e.likelyTouchDevice ||
                         t.bind(e.scrollWrap, "mouseover", f.onMouseOver)
                 })), l("unbindEvents", (function () {
                     u && clearInterval(u), t.unbind(document, "mouseout", L), t.unbind(document,
                         "mousemove", k), t.unbind(i, "pswpTap click", _), t.unbind(e.scrollWrap,
                         "pswpTap", f.onGlobalTap), t.unbind(e.scrollWrap, "mouseover", f.onMouseOver)
                 })), l("destroy", (function () {
                     d.captionEl && t.removeClass(a, "pswp__caption--empty"), t.removeClass(i,
                         "pswp__ui--over-close"), t.addClass(i, "pswp__ui--hidden"), f.setIdle(!1)
                 })), d.showAnimationDuration || t.removeClass(i, "pswp__ui--hidden"), l("initialZoomIn", (
                     function () {
                 ...
                 function () {
                     var e, a, n, o = function (t) {
                         if (t)
                             for (var i = t.length, o = 0; o < i; o++) {
                                 e = t[o], a = e.className;
                                 for (var l = 0; l < C.length; l++) n = C[l], a.indexOf("pswp__" + n.name) >
                                     -1 && d[n.option] && n.onInit && n.onInit(e)
                             }
                     };
                     o(i.children);
                     ...
                     t.bind(document, "mousemove", k), t.bind(document, "mouseout", L), u = setInterval(
                         (function () {
                             2 == ++H && f.setIdle(!0)
                         }), d.timeToIdle / 2)
                     ...
                     clearTimeout(c), c = setTimeout((function () {
                         e.currItem && e.currItem.loading ? (!e.allowProgressiveImg() ||
                             e.currItem.img && !e.currItem.img.naturalWidth) && V(!
                             1) : V(!0)
             ...
             x && e.currItem ? (f.updateIndexIndicator(), d.captionEl && (d.addCaptionHTMLFn(e.currItem, a), b(
                 a, "caption--empty", !e.currItem.title)), g = !0) : g = !1, w()
             ...
             if (!m)
                 if (i.detail && "mouse" === i.detail.pointerType) {
                     ...
                     t.hasClass(a, "pswp__img") && (1 === e.getZoomLevel() && e.getZoomLevel() <= e.currItem.fitRatio ?
                         d.clickToCloseNonZoomable && e.close() : e.toggleDesktopZoom(i.detail.releasePoint)
                     )
                 } else if (d.tapToToggleControls && (x ? f.hideControls() : f.showControls()), d.tapToClose &&
                 (t.hasClass(a, "pswp__img") || y(a))) return void e.close()
     ...
     function $() {
         yall({
             ...
             events: {
                 load: function (e) {
                     e.target.parentNode.parentNode.classList.add("img-loaded"), e.target.parentNode.classList
                         .remove("img-bg")
                 }
             }
         ...
         function e(e) {
             e || (R.pswp.style.width = window.getComputedStyle(R.pswp).width), document.body.style.width = e ? window.getComputedStyle(
                     document.body).width : "", document.body.style.overflow = e ? "hidden" : "", N.popup.overflow_hidden = !
                 !e
         }
         function t(e) {
             !N.popup.is_open || x.items.length < 2 || (T(["left", "right"], (function (e) {
                 e.ctrlKey || e.altKey || e.shiftKey || e.metaKey || (e.preventDefault(), E.popup_transition(
                     37 === e.keyCode))
         ...
         function u(e) {
             N.popup.is_playing && (isNaN(e) && (e = x.getCurrentIndex()), x.items[e].loaded && e === x.getCurrentIndex() &&
                 (o(!0), N.popup.is_timing = !0, N.popup.timer = setTimeout(E.popup_transition, _c.popup_interval))
             )
         }
         E.popup_transition = function (e) {
                 ...
                 N.popup.is_playing = !N.popup.is_playing, w.classList.toggle("is-playing", N.popup.is_playing), W.is_pointer &&
                     (w.dataset.tooltip = G(N.popup.is_playing ? "暂停" : "播放")), N.popup.is_playing || p(), N.popup.is_playing &&
                     u()
             }, R.pswp.innerHTML =
             '<div class="pswp__bg"></div>\t  <div class="pswp__scroll-wrap">\t    <div class="pswp__container' + (_c.server_exif ?
                 " server-exif" : "") +
             '">\t      <div class="pswp__item"></div>\t      <div class="pswp__item"></div>\t      <div class="pswp__item"></div>\t    </div>\t    <div class="pswp__ui pswp__ui--hidden">\t      <div class="pswp__top-bar">\t        <div class="pswp__counter"></div>\t        <div class="pswp__search"></div>\t        <button class="pswp__button pswp__button--close"' +
             f(G("关闭 (esc)")) + ">" + E.get_svg("close") + "</button>" + (W.fullscreen ?
                 '<button class="pswp__button pswp__fullscreen"' + f(G("全屏窗口")) + ">" + E.get_svg_multi("expand",
                     "collapse") + "</button>" : "") + '\t        <button class="pswp__button pswp__button--zoom"' + f(
                 G("放大")) + ">" + E.get_svg_multi("zoom_in", "zoom_out") +
             '</button>\t        <button class="pswp__button pswp__play"' + f(G("播放")) + ">" + E.get_svg_multi("play",
                 "pause") + "</button>" + (!W.is_pointer && W.download ?
                 '<a class="pswp__button pswp__download" href="#"' + f(G("download")) + ' target="_blank" download>' +
                 E.get_svg("download") + "</a>" : "") + d(W.is_pointer, "pswp__button pswp__contextmenu", !0) +
             '\t        <div class="pswp__preloader"></div>\t      </div>\t      <button class="pswp__button pswp__button--arrow--left" title="' +
             G("上一个") + '">' + E.get_svg("arrow_left") +
             '</button>\t      <button class="pswp__button pswp__button--arrow--right" title="' + G("下一个") + '">' + E.get_svg(
                 "arrow_right") +
             '</button>\t      <div class="pswp__caption"><div class="pswp__caption__center"></div></div>\t    </div>\t  </div>\t  <div class="pswp__timer"></div>',
             N.popup = {}, (isNaN(_c.popup_interval) || _c.popup_interval < 2e3) && (_c.popup_interval = 2e3);
             ...
             if (o && N.list.items.length) {
                 ...
                 if (N.list.matchingItems.forEach((function (e) {
                         ...
                         if (t.is_browser_image /*!is_browser_image(values)*/ && t.is_readable) {
                             ...
                             "ico" === t.ext && e.w < 128 && (e.h = Math.round(e.h / e.w * 128), e.w = 128),
                                 i && i.src && !a && (e.msrc = i.src), f.push(e), o === t.path && (w = h, a &&
                                     (s = !0)), h++
                         }
                     })), f.length) {
                     N.popup.is_open = !0, W.scrollbar_width && window.innerWidth > document.documentElement.clientWidth &&
                         e(!0), _.style.display = R.filter.value ? "block" : "none", _.innerHTML = R.filter.value ?
                         E.get_svg("image_search_outline") + '"' + i(R.filter.value) + '"' : "";
                     var H = f[w].img_el;
                     (x = new PhotoSwipe(R.pswp, K, f, {
                         ...
                         addCaptionHTMLFn: function (e, t) {
                             var i = e.item;
                             if (!i) return !1;
                             i.image && i.image.iptc && i.image.iptc, i.image && i.image.exif && i.image
                                 .exif;
                             if (y && (y.href = n(i, !0)), L.innerHTML = d(W.is_pointer,
                                     "popup-context") + g(i.basename, "div", "popup-basename") + c(i.image,
                                     "span", "popup-dimensions", !0) + r(i, "span", "popup-filesize", !
                                     0) + g(g(E.get_time(i, M, !1, C), "span", !1, i.DateTimeOriginal ?
                                     "DateTimeOriginal" : G("修改时间")), "span", "popup-date") + v(i.image,
                                     "div", "popup-exif", !0) + m(i.image, "popup"), 1 !=
                                 getComputedStyle(t).getPropertyValue("opacity")) return !0;
                             var a = L.children,
                         ...
                         getThumbBoundsFn: function (e) {
                             if (!s) {
                                 var t = f[e],
                                     i = N.modal.open ? N.modal.file === t.item && _class("modal-image",
                                         R.modal)[0] : t.img_el;
                                 if (a(i) && t.msrc) {
                     ...
                     })).listen("beforeChange", p), x.listen("imageLoadComplete", u), x.listen("afterChange", u), x
                         .listen("close", (function () {
                             T(["left", "right"], "keyup"), T("space", "keyup"), k.classList.remove(
                                     "pswp__preloader--active"), N.popup.is_playing && E.toggle_play(), N.popup
                                 .is_open = !1, N.popup.overflow_hidden && e(!1)
     ...
     function () {
         if (_c.menu_enabled) {
             R.sidebar = _id("sidebar"), R.sidebar_inner = _id("sidebar-inner"), R.sidebar_menu = _id("sidebar-menu"),
                 R.sidebar_toggle = _id("sidebar-toggle"), R.sidebar_modal = _id("sidebar-bg"), R.sidebar_topbar = _id(
                     "sidebar-topbar");
             var e, a, o, l, p, s, c = !1,
                 r = !1,
                 d = {},
             ...
             v || document.documentElement.classList.add("sidebar-closed"), E.menu_loading = function (e, t) {
                 ...
                 }, R.sidebar_toggle.innerHTML = E.get_svg_multi("menu", "menu_back"), b(R.sidebar_toggle, C, "click"),
                 b(R.sidebar_modal, C, "click");
             ...
             !(!f || x && ! function () {
                 ...
                 return !0
             }()) ? T(g, "menu from localstorage [" + (_c.menu_cache_validate ? "shallow menu" :
                 "menu cache validation disabled") + "]"): (R.sidebar_menu.classList.add("sidebar-spinner"), R.sidebar_menu
                 .dataset.title = G("loading") + " …", q({
                     params: !_c.menu_cache_file && "action=dirs" + (_c.cache ? "&menu_cache_hash=" + _c.menu_cache_hash :
                         "") + (f ? "&localstorage=1" : ""),
                     url: _c.menu_cache_file,
                     json_response: !0,
                     complete: function (e, t, i) {
                         if (R.sidebar_menu.classList.remove("sidebar-spinner"), delete R.sidebar_menu.dataset
                             .title, !i || !e || e.error || !Object.keys(e).length) return J(), void j(
                             "Error or no dirs!");
                         e.localstorage ? T(g, "menu from localstorage") : (T(e, "menu from " + (_c.menu_cache_file ?
                                 "JSON cache: " + _c.menu_cache_file : "xmlhttp")), W.local_storage &&
                             setTimeout((function () {
                                 E.clean_localstorage(), S("files:menu:" + _c.menu_cache_hash,
                                     t)
                             }), 1e3))
                     }
         ...
         function w(e, t) {
             if (e) {
                 ...
                 for (var i = e.parentNode.parentNode.parentNode; i.classList.contains("menu-li");) i.classList.toggle(
                     "menu-active-ancestor", t), i = i.parentNode.parentNode
             }
         }
         function H(t, i) {
             ...
             var n = Object.keys(d).length,
                 l = n === o.length;
             m !== l && (m = l, e.classList.toggle("is-expanded", m)), W.local_storage && (c && clearTimeout(c), c =
                 setTimeout((function () {
         ...
         function C(e) {
             E.set_option("menu_show", !_c.menu_show), document.documentElement.classList.toggle("sidebar-closed"), v = !
                 v
         }
         function z(e, t) {
         ...
         function A(e, a) {
             ...
             return a ? (o += " has-ul", u && u[e.path] && (o += " is-open", d[e.path] = !0)) : e.is_readable || (o +=
                     " li-forbidden"), '<li data-level="' + l + '" data-path="' + t(e.path) + '" class="' + o +
                 '"><a href="' + n(e) + '" class="menu-a menu-a-' + l + '">' + (a ? '<span class="menu-icon-toggle">' +
                     E.get_svg_multi("plus", "minus") + "</span>" : "") + '<span class="menu-icon-folder' + (a ?
                     " menu-icon-folder-toggle" : "") + '">' + (a ? E.get_svg_multi(p, "folder_plus", "folder_minus") :
                     E.get_svg(p)) + "</span>" + i(e.basename) + "</a>"
         }
         function T(t, i) {
             ...
             if (J(), j(i, t), _c.dir_paths = [], V(t, (function (e) {
                     ...
                     if (e) {
                         var i = (e.match(/\//g) || []).length + 1,
                             a = i - s;
                         s = i, c += a, u && (n += A(u, a > 0)), n += a > 0 ? '<ul class="menu-' + (u ? "ul" :
                             "root") + '">' : "</li>" + z("</ul></li>", -a), u = _c.dirs[e]
                     }
                 })), n += A(u, !1) + z("</li></ul>", c), R.sidebar_menu.innerHTML = n, a = R.sidebar_menu.firstChild,
                 o = _class("has-ul", a), l = o.length ? L(Array.from(a.children), "has-ul", !0) : [], f = l, p = o.filter(
                     (function (e) {
                         return !f.includes(e)
                     })), V(_class("menu-li", a), (function (e) {
                     var t = _c.dirs[e.dataset.path];
                     t && (t.menu_li = e)
                 })), E.set_menu_active(_c.current_path || _c.init_path), N.ls_options.menu_scroll && (R.sidebar_menu.scrollTop =
                     N.ls_options.menu_scroll), W.local_storage && b(R.sidebar_menu, y((function () {
                     E.ls_option("menu_scroll", R.sidebar_menu.scrollTop)
                 }), 1e3), "scroll"), o.length && (g = !1, m = Object.keys(d).length === o.length, R.sidebar_topbar.innerHTML =
                     '<button id="menu-toggle" type="button" class="btn-icon' + (m ? " is-expanded" : "") + '">' + E.get_svg_multi(
                         "plus", "minus") + "</button>", b(e = R.sidebar_topbar.lastChild, (function (e) {
                         if (m) {
                             var t = [],
                                 i = [],
                                 a = !1,
                             ...
                             V(l, (function (e) {
                                 if (e.classList.contains("is-open"))
                                     if (a) t.push(e);
                                         ...
                                         o.top > n || o.bottom - o.top > 2 * n ? (t.push(e), a = !0) :
                                             i.push(e)
                                     }
                         ...
                         } else o.length > 100 ? k(o, "is-open", !0) : (t = [], i = [], a = !1, n = window.innerHeight,
                             V(o, (function (e) {
                                 e.classList.contains("is-open") || (a || !e.offsetParent ? t.push(
                                         e) : e.getBoundingClientRect().top > n || e.lastChild.childNodes
                                     .length > 50 ? (a = !0, t.push(e)) : i.push(e))
                             })), t.length && V(t, (function (e) {
                 ...
                 var S = {
                     targets: function () {
                         for (var e = [], t = a.children, i = t.length, n = R.sidebar_inner.clientHeight, o = 0; o <
                             i; o++) {
                             var l = t[o];
                 ...
                 S.delay = anime.stagger((x = Math.round(200 / S.targets.length), w = 50, T = 20, Math.min(Math.max(x,
                     T), w))), anime(S)
             }
             b(a, (function (e) {
                 ...
                 if (e.target !== a) {
                     ...
                     if (!_(e, n))
                         if (t && n !== r) E.get_files(i.dataset.path, "push"), matchMedia(
                             "(min-width: 992px)").matches ? _c.menu_show || h(R.sidebar,
                             "sidebar-clicked", null, 1e3) : C();
     ...
     function () {
         function e(e, t) {
             N.sort.keys.includes(e) || (e = "name"), ["asc", "desc"].includes(t) || (t = N.sort.sorting[e].sort),
                 Object.assign(N.sort, {
                     sort: e,
                     order: t,
                     multi: "asc" === t ? 1 : -1,
         ...
         i.innerHTML = '<button type="button" class="btn-icon btn-topbar">' + E.get_svg("sort_" + N.sort.sort) +
             '</button><div class="dropdown-menu dropdown-menu-right"><h6 class="dropdown-header">' + G("分类") + "</h6>" +
             M(N.sort.keys, (function (e) {
                 return '<button class="dropdown-item' + (e === N.sort.sort ? " active sort-" + N.sort.order :
                         "") + '" data-action="' + e + '">' + E.get_svg("sort_" + e) + N.sort.sorting[e].lang +
                     E.get_svg_multi("menu_down", "menu_up") + "</button>"
             })) + "</div>";
         var a = i.firstChild,
         ...
         function p(e, t) {
             return e._values[N.sort.prop] === t._values[N.sort.prop] ? e._values.sort_name < t._values.sort_name ? -1 :
                 1 : e._values[N.sort.prop] < t._values[N.sort.prop] ? -1 : 1
         }
         function c(e, t, i) {
             var a = i ? "add" : "remove";
             e && (o[N.sort.index].classList[a]("active"), r[N.sort.index].classList[a]("sortbar-active")), (e || t) &&
                 (o[N.sort.index].classList[a]("sort-" + N.sort.order), r[N.sort.index].classList[a]("sort-" + N.sort.order))
         }
         E.set_sort = function (t) {
                 if (t) {
                     var i = t !== N.sort.sort,
                         ...
                         o = n !== N.sort.order;
                     c(i, o, !1), e(t, n), i && (a.innerHTML = E.get_svg("sort_" + t)), c(i, o, !0), E.set_option(
                         "sort", N.sort.sort + "_" + N.sort.order)
                 }
             ...
             })), s(n, E.set_sort), R.sortbar = _id("files-sortbar"), R.sortbar.className = "sortbar-" + _c.layout + (
                 "list" === _c.layout && N.ls_options.layout_subindex ? "-big" : ""), R.sortbar.innerHTML =
             '<div class="sortbar-inner">' + M(N.sort.keys, (function (e) {
                 return '<div class="sortbar-item sortbar-' + e + (e === N.sort.sort ? " sortbar-active sort-" +
                     N.sort.order : "") + '" data-action="' + e + '">' + N.sort.sorting[e].lang + E.get_svg_multi(
                     "menu_down", "menu_up") + "</div>"
             })) + "</div>";
         ...
         s(R.sortbar, E.set_sort)
             ...
             if (e.target.dataset.tooltip) {
                 ...
                 i.push("tooltip-" + (t.top > 100 ? "top" : "bottom")), t.left < 100 ? i.push("tooltip-right") :
                     t.right > document.documentElement.clientWidth - 100 && i.push("tooltip-left");
                 var a = i.join(" ");
         ...
         function () {
             ...
             if (N.topbar = {
                     info: {}
                 }, R.filter.placeholder = G("搜索"), R.filter.title = (e = "F", G("搜索") + " [" + (W.is_mac ? "⌘" :
                     "ctrl-") + e + "]"), _c.has_login) {
                 var t = _id("logout");
                 t.innerHTML = E.get_svg("logout"), t.dataset.tooltip = G("logout"), t.classList.add("tooltip-left",
                     "tooltip-bottom"), b(t, (function (e) {
                     confirm("are you sure you want to log out?") || e.preventDefault()
                 }))
             }
             var i = _id("topbar-fullscreen");
             screenfull.isEnabled ? (i.innerHTML = E.get_svg_multi("expand", "collapse"), i.dataset.tooltip = G("全屏窗口"),
                 i.classList.add("tooltip-left", "tooltip-bottom"), i.addEventListener("click", (function () {
                     screenfull.toggle()
                 ...
                 e ? (R.topbar_info.className = "info-" + t, R.topbar_info.innerHTML = e, N.topbar.info.type = t) :
                     function (e) {
                 ...
                 R.topbar_info.classList.toggle("nomatches", !t), "search" === N.topbar.info.type ? (R.topbar_info.classList
                     .contains("info-search") || R.topbar_info.classList.add("info-search"), _class(
                         "info-search-count", R.topbar_info)[0].innerText = t, _class("info-search-phrase", R.topbar_info)[
                         0].innerText = e) : E.topbar_info('<span class="info-search-count">' + t + "</span>" +
                     G("找到符合的") + '<span class="info-search-phrase">' + e +
                     '</span><button class="info-search-reset" title="' + G("remove search") +
                     '" data-action="reset">' + E.get_svg("close") + "</button>", "search")
             }
         }(), "IntersectionObserver" in window && "IntersectionObserverEntry" in window && "intersectionRatio" in
         window.IntersectionObserverEntry.prototype ? $() : E.load_plugin("intersection-observer", $, {
